...
try:
	...
	ips=requests.get("http://ip-api.com/json/"+b,headers={"Referer":"http://ip-api.com/","Content-Type":"application/json; charset=utf-8","User-Agent":"Mozilla/5.0 (Linux; Android 6.0.1; SM-G955F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"}).json()["country"].lower()
except:
	ips=None
...
def logs():
  os.system("clear")
  banner()
  print((k+"\n["+p+"1"+k+"]"+p+" Login Via Token"))
  print((k+"["+p+"2"+k+"]"+p+" Login Via Cookies"))
...
def gen():
        ...
        try:
                ...
                "user-agent"                : "Mozilla/5.0 (Linux; Android 6.0.1; SM-G955F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36", # Jangan Di Ganti Ea Anjink.
